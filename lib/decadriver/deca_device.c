...
void readReceivePower(uint16* cirPwr , uint16* rxFrameInfo)
{
    *cirPwr=dwt_read16bitoffsetreg(RX_FQUAL_ID, 0x04);
    *rxFrameInfo=(dwt_read32bitreg(RX_FINFO_ID) & RX_FINFO_RXPACC_MASK) >> RX_FINFO_RXPACC_SHIFT;
} 
