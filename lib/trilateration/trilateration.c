...
int GetLocation(vec3d *best_solution, int use4thAnchor, vec3d *anchorArray, int *distanceArray)
{
    ...
    if (use4thAnchor == 0) // 3基站定位
    {
        ...
        {
            /* Anchors coordinate */
            p1.x = anchorArray[1].x;
            p1.y = anchorArray[1].y;
            p1.z = anchorArray[1].z;
            p2.x = anchorArray[2].x;
            p2.y = anchorArray[2].y;
            p2.z = anchorArray[2].z;
            p3.x = anchorArray[3].x;
            p3.y = anchorArray[3].y;
            p3.z = anchorArray[3].z;
            p4.x = p1.x;
            p4.y = p1.y;
            p4.z = p1.z;
